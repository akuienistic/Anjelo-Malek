    ...
    <section id="contact" className="section-padding bg-gradient-to-b from-secondary to-background">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <h2 className="font-serif text-4xl md:text-5xl font-bold text-primary mt-4 mb-6">
            Contact Me
          </h2>
          <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
            Interested in collaboration, investment opportunities, or learning more about my work? 
          ...
          >
            <div className="bg-card rounded-2xl p-8 shadow-card">
              ...
              <p className="text-muted-foreground mb-8">
                Whether you're interested in business opportunities, community initiatives, 
                or simply want to connect, I'm always open to meaningful conversations about 
                South Sudan's development.
              </p>
